...
/**
 * [android.app.Activity] which contains a simple calculator. Numbers can be entered in the
 * two [EditText] fields and result can be obtained by pressing one of the
 * operation [Button]s at the bottom.
 */
class CalculatorActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mResultTextView = findViewById(R.id.operation_result_text_view) as TextView
        mOperandOneEditText = findViewById(R.id.operand_one_edit_text) as EditText
        mOperandTwoEditText = findViewById(R.id.operand_two_edit_text) as EditText
    }
